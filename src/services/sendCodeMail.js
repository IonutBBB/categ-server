...
const generateTemplate = code =>
  `
    <div style="margin: 0 auto 25px auto;padding-bottom: 10px; border-bottom: 1px solid #000;">
        <img width="300" border="0" style="display: inline-block;" src="${logoUrl}" title="SH" alt="SH" />
...
module.exports = (userEmail, code) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    const mailOptions = {
      from: '"SmartHarvest Service" <support@smartharvest.io>', // sender address
      to: userEmail,
